  ...
  return (
    ...
    >
      ...
      >
        <span
          aria-hidden="true"
          className="mb-3 grid size-8 place-items-center rounded-full bg-shinta-orange text-[25px] leading-none font-normal text-totem-brand"
        >
          ×
        </span>
        <p className="text-[24px] leading-[33.6px] font-medium tracking-[-0.6px]">
          {painPoint}
        </p>
      </motion.div>
    </li>
...
export function PainPointsSection() {
  ...
  return (
    <section
      className="relative h-[3600px] overflow-clip max-[480px]:h-[3376px]"
      ref={sectionRef}
    >
      <motion.div
        className="sticky top-0 h-screen min-h-[900px] overflow-hidden px-5 max-md:min-h-[650px] max-[480px]:px-0"
